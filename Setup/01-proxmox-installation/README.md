...
| Component | Details |
|---|---|
| Hardware | Dell OptiPlex 7060 Micro |
| CPU | Intel Core i5-8500T 6-Core |
| RAM | 32GB DDR4 |
| Storage | 512GB NVMe SSD |
| Hypervisor | Proxmox VE 8.x |
| Network | Static IP — 192.168.1.50 |
| Management Access | Browser-based Web UI via https://192.168.1.50:8006 |

---

## Hardware Verification

Prior to wiping the stock Windows 11 Pro installation, hardware specifications were verified through Windows System Settings and Disk Management to confirm the unit matched advertised specifications.

<img width="3326" height="1276" alt="Optiplexe System Summary" src="https://github.com/user-attachments/assets/6e688a0b-7634-4744-a503-b93867dd4db7" />
<img width="754" height="595" alt="OptiPlex Hardware Specs" src="https://github.com/user-attachments/assets/919c19a4-e35a-4a6a-9cfe-67fbd291fb76" />
...
Downloaded the Proxmox VE 8.x ISO directly from proxmox.com and flashed it to a 16GB USB drive using Balena Etcher. The bootable USB was created directly on the Dell running Windows 11 Pro, eliminating the need for a separate machine.

<img width="1686" height="1253" alt="Proxmox Download" src="https://github.com/user-attachments/assets/e1f654ce-4ecb-46bd-972f-3fc61e6faa37" />
...
| Setting | Value |
|---|---|
| Interface | eno1 (onboard ethernet) |
...
### Challenge 1 — Secure Boot Blocking Installation
**Issue:** Proxmox installer failed to load on first boot attempt due to Secure Boot being enabled by default in Dell BIOS.
...
<img width="1478" height="489" alt="Screenshot 2026-04-10 at 2 15 41 PM" src="https://github.com/user-attachments/assets/1d171716-45cd-43b5-9fea-82bdbf19117a" />
<img width="1506" height="824" alt="Screenshot 2026-04-07 at 11 13 11 PM" src="https://github.com/user-attachments/assets/277b38f6-d1d2-436b-b791-213e3a1a4002" />

---

## Result

A fully operational Type 1 hypervisor running on dedicated hardware, remotely accessible from any device on the local network. This forms the foundation of the homelab environment — all subsequent virtual machines, network segments, and security tooling are deployed and managed through this Proxmox instance.aa
